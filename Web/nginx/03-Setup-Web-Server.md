...
- A server with **Nginx installed**. If you haven’t installed Nginx yet, follow the installation instructions in the [Nginx Installation Guide](02-Installtion.md) (or use the provided installation commands).
